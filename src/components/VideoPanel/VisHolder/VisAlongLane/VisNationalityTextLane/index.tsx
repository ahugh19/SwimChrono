...
interface VisNationalityTextLaneProps {
  layerList: LayerType[],
...
function VisNationalityTextLane(props: VisNationalityTextLaneProps) {
  ...
  useEffect(() => {
    ...
    if (_thisFrameLaneList && _thisFrameLaneList[laneIndex]) {
      ...
      setTextStyle(editableElementList.find(
        (e) => e.id === editableElementInVisConfig.nationalityTextLane[0].id
      ))
    }
...
export default VisNationalityTextLane