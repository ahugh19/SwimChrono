...
interface VisDistanceToLeaderTextLaneProps {
  layerList: LayerType[],
...
function VisDistanceToLeaderTextLane(props: VisDistanceToLeaderTextLaneProps) {
  ...
  useEffect(() => {
    ...
    if (_thisFrameLaneList && _thisFrameLaneList[laneIndex]) {
      ...
      setTextStyle(editableElementList.find(
        (e) => e.id === editableElementInVisConfig.distanceToLeaderTextLane[0].id
      ))
    }
...
export default VisDistanceToLeaderTextLane