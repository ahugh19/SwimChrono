...
interface VisDistanceSwumTextLaneProps {
  layerList: LayerType[],
...
function VisDistanceSwumTextLane(props: VisDistanceSwumTextLaneProps) {
  ...
  useEffect(() => {
    ...
    if (_thisFrameLaneList && _thisFrameLaneList[laneIndex]) {
      ...
      setTextStyle(editableElementList.find(
        (e) => e.id === editableElementInVisConfig.distanceSwumTextLane[0].id
      ))
    }
...
export default VisDistanceSwumTextLane